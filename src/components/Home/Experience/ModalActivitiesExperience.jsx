...
const ModalActivitiesExperience = function ({ job }) {
  function createUsedStacks(stacks) {
    return (
      stacks.map((stack, index) => (
        <img className="m-1" src={stack.url} alt={stack.name} key={index} />
      ))
    );
  }
      ...
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          ...
          <div className="modal-body">
            <p className="card-text text-justify" dangerouslySetInnerHTML={{ __html: job.activity.description }} />
